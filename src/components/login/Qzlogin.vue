<template>
	<div class="Qzlogin">
		<div class="loginform">
			...
			<el-tabs v-if="tabform" v-model="qzactiveName" stretch>
				<el-tab-pane label="短信登录" name="first">
					<el-form :model="dxruleForm" status-icon :rules="dxrules" ref="dxruleForm" class="demo-ruleForm">
						...
						<el-form-item>
							...
							<router-link to="/public/forgotPassword?user=1" style="color: #ff5656;float: right;">忘记密码</router-link>
						</el-form-item>
					</el-form>
				</el-tab-pane>
			...
			dxsubmitForm(formName) {
				...
				that.$refs[formName].validate((valid) => {
					if (valid) {
						...
						var pwd = '';
						var activeName_ = that.qzactiveName;
...
<style scoped>
	.Qzlogin {
		height: 37.5rem;
		background: url(../../assets/images/common/qiuzhibg.png) 10% no-repeat;
	}
	.el-button {

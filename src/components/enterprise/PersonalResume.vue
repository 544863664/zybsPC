  ...
  <div class="resume">
    ...
    <div class="body">
      ...
      <div class="user_info">
        ...
        <a href="javascript:window.print()" >下载 <span style="color:#666;font-size:13px;">(点击下载选择打印机Microsoft Print to PDF，点击打印即可下载，如需更多设置如：修改尺寸，横纵向布局等点击下载后操作更多设置按钮)</span></a>
      </div>
      <div class="resume_con">
        ...
        <div class="resume_r">
          <!-- 求职意向 -->
          <div class="r_block r_block_1" v-if="qzdetail">
            <div class="title">
              <span>求职意向</span>
            </div>
            <div class="content" v-for="(item,i) in qzlist" :key="i">
              <ul class="r_block_1">
                <li>
                  ...
                  <span class="val">{{ProvinceMap[item.sjm]}}{{CityMap[item.sjm][item.csmc]}}</span>
                </li>
                <li>
                ...
                <li>
                  ...
                  <span class="val">{{JobCategoryThirdMap[item.zwmt][item.zwm]}}</span>
                </li>
                <li>
                  <span class="name">行业类别：</span>
                  <span class="val">{{findDmMap['m_dwsshydm'][item.hym]}}</span>
                </li>
                <li>
                ...
                <li>
                  ...
                  <span class="val">{{findDmMap['m_xzdydm'][item.yxm]}}</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <!-- <div class="r_block r_block_4" v-if="jyjldetail">
            <div class="title">
              <span>教育经历</span>
            </div>
                ...
                <dd>
                  <ul class="r_block_1">
                    ...
                    <li>
                      ...
                      <span class="val">{{findDmMap['m_xldm'][item.xl]}}</span>
                    </li>
                    <li>
          ...
          <!-- <div class="r_block r_block_3" v-if="pxjldetail">
            <div class="title">
              <span>培训经历</span>
            </div>
          ...
          <!-- 语言能力 -->
          <!-- <div class="r_block r_block_1" v-if="yynldetail">
            <div class="title">
              <span>语言能力</span>
            </div>
          ...
          <!-- <div class="r_block r_block_1" v-if="shhddetail">
            ...
            <div class="content" v-for="(item,i) in shhdlist" :key="i">
              <ul class="r_block_1">
                ...
                <li class="percent">活动成果：{{item.hdcg}}</li>
              </ul>
            </div>
          </div> -->
           <!-- 参与社会活动 -->
...
export default {
  ...
  methods: {
    ...
    Characterdetails() {
      this.axios({
        url: `/api/hr/qyhxrxx/findQzxxInfo/${this.$route.query.qzbsid}`,
        method: "get",
        headers: {
          token: this.token
        }
        ...
        .then(res => {
          ...
          if (res && res.data && res.data.code === 0) {
            ...
            this.Character.email= res.data.qzinfo.email; //手机号码
            this.Character.gznx = res.data.qzinfo.gznx; //工作年限
            this.Character.zgxl = res.data.qzinfo.zgxl; //工作年限
            this.qzlist = res.data.qzinfo.qzyxlist; //求职列表
            ...
            this.xmjylist = res.data.qzinfo.qzxmjylist; //项目经验列表
            ...
            this.jylist = res.data.qzinfo.qzjyjllist; //教育经历列表
    ...
    gzdetail() {
      this.axios({
        url: `/api/hr/qyhxrxx/findQzxxGzjyInfo/${this.$route.query.qzbsid}`,
        method: "get",
        headers: {
          token: this.token
        }
    ...
    yjdetail() {
      this.axios({
        url: `/api/hr/qyhxrxx/findQzxxYjfxInfo/${this.$route.query.qzbsid}`,
        method: "get",
        headers: {
          token: this.token
        }
    ...
    lwdetail() {
      this.axios({
        url: `/api/hr/qyhxrxx/findQzxxLwxxInfo/${this.$route.query.qzbsid}`,
        method: "get",
        headers: {
          token: this.token
        }
    ...
    kydetail() {
      this.axios({
        url: `/api/hr/qyhxrxx/findQzxxKyjlInfo/${this.$route.query.qzbsid}`,
        method: "get",
        headers: {
          token: this.token
        }
    ...
    pxdetail() {
      this.axios({
        url: `/api/hr/qyhxrxx/findQzxxPxjlInfo/${this.$route.query.qzbsid}`,
        method: "get",
        headers: {
          token: this.token
        }
    ...
    zldetail() {
      this.axios({
        url: `/api/hr/qyhxrxx/findQzxxZlxxInfo/${this.$route.query.qzbsid}`,
        method: "get",
        headers: {
          token: this.token
        }
    ...
    yydetail() {
      this.axios({
        url: `/api/hr/qyhxrxx/findQzxxYynlInfo/${this.$route.query.qzbsid}`,
        method: "get",
        headers: {
          token: this.token
        }
    ...
    zydetail() {
      this.axios({
        url: `/api/hr/qyhxrxx/findQzxxZyjnInfo/${this.$route.query.qzbsid}`,
        method: "get",
        headers: {
          token: this.token
        }
    ...
    zsdetail() {
      this.axios({
        url: `/api/hr/qyhxrxx/findQzxxZsxxInfo/${this.$route.query.qzbsid}`,
        method: "get",
        headers: {
          token: this.token
        }
    ...
    rydetail() {
      this.axios({
        url: `/api/hr/qyhxrxx/findQzxxRyjlInfo/${this.$route.query.qzbsid}`,
        method: "get",
        headers: {
          token: this.token
        }
    ...
    shdetail() {
      this.axios({
        url: `/api/hr/qyhxrxx/findQzxxShhdInfo/${this.$route.query.qzbsid}`,
        method: "get",
        headers: {
          token: this.token
        }
